...
//  LuPing
//
//  Created by zqs on 15/7/14.
//  Copyright (c) 2015年 MAC2. All rights reserved.
//
...
#define addText(...) {};
//#define addText(...) NSLog(__VA_ARGS__)

@interface LKTestMain ()

@end

@implementation LKTestMain
...
-(void)test
{
    ...
    NSMutableArray *temp = [LKTest searchWithSQL:@"select * from @t,LKTestAddress"];
    addText(@"%d" , temp.count);
